...
The SDK also exports `CELO` for the Celo L2 (see [Celo](/sdk/celo)) and `BASE` for the L2 Keystore cache used by cross-chain verification.

## What's next

- [Networks & Addresses](/concepts/networks). Chain ids, RPCs, and contract addresses.
- [BNB Testnet](/sdk/bnb-testnet). Build against chain 97 with a faucet before going to mainnet.
